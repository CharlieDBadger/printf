...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/14 17:19:02 by cbolanos          #+#    #+#             */
/*   Updated: 2025/01/14 17:19:04 by cbolanos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ft_uint_to_hexc(unsigned int num);

/**
 * ft_putn_hexc - Converts an unsigned integer to its hexadecimal string 
 *                representation and writes it to the standard output.
 * @num: The unsigned integer to be converted.
 *
 * This function converts the given unsigned integer to its hexadecimal 
 * representation using uppercase letters ('A' to 'F'). It then outputs 
...
/**
 * ft_uint_to_hexc - Converts an unsigned integer to its hexadecimal string 
